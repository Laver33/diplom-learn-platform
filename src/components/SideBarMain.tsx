...
// Хуки для мобильной адаптации
import { useIsMobile } from '../hooks/use-mobile'
import { useMobileMenuStore } from '../app/store/mobileMenuStore'
import { cn } from "@/lib/utils" // если у вас есть, или можно просто классы добавить
...
const SideBarMain = () => {
    ...
    // Если мобильное устройство и меню закрыто – не рендерим
    ...
    return(
        <>
            ...
            <Sidebar className={cn(
                isMobile && 'fixed left-0 top-0 z-50 h-screen w-72 shadow-2xl'
            )}>
                {/* Хедер */}
                ...
                <SidebarContent className="px-3 py-4">
                    ...
                    {userRole === 'admin' ? 
                        <SidebarMenuItem className="mt-2 pt-3 border-t border-slate-200/60">
                            <Link href={'/adminpanel'} onClick={() => { if (isMobile) close(); }}>
