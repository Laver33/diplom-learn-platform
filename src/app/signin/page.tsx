...
import { ForgotPasswordModal } from "@/components/auth/ForgotPasswordModal" // Импортируй модалку
...
const SignIn = () => {
    ...
    const [isForgotPasswordOpen, setIsForgotPasswordOpen] = useState(false) // Состояние для модалки
                ...
                <div className="relative z-10 w-full max-w-md px-4">
                    <form className="bg-white/80 backdrop-blur-sm shadow-2xl rounded-2xl p-8 border border-slate-200/60 transition-all duration-500 hover:shadow-2xl">
                        ...
                        <div className="space-y-4">
                            ...
                            {/* Забыли пароль? - открывает модалку */}
